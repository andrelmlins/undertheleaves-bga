...
var BeingsManager = /** @class */ (function () {
    ...
    BeingsManager.prototype.setupNotifications = function () {
        ...
        dojo.subscribe('arrivalSkipperPuddle', this, function (notif) { return _this.arrivalSkipperPuddleNotif(notif); });
        dojo.subscribe('majorityBonus', this, function (notif) { return _this.majorityBonusNotif(notif); });
    };
    BeingsManager.prototype.renderSkipperPuddle = function (being) {
        var _a;
    ...
    BeingsManager.prototype.arrivalSkipperPuddleNotif = function (notif) {
        return __awaiter(this, void 0, void 0, function () {
